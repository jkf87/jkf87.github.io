...
![4컷 만화 그리기 예시](images/webtooni-examples-1.png){width=600}

### 2. 투명 이미지 만들기

생성된 일러스트에서 투명 배경을 추출합니다.

![투명 이미지 예시](images/webtooni-examples-2.png){width=600}

### 3. 텍스트 레이어링

텍스트를 캐릭터에 자연스럽게 배치합니다.

![텍스트 레이어링 예시](images/webtooni-examples-3.png){width=600}

### 4. 스케치 (Sketch)

캐릭터의 초기 스케치를 생성합니다.

![스케치 예시](images/webtooni-examples-4.png){width=600}
...
![디테일드 디렉션 예시](images/webtooni-examples-5.png){width=600}

### 6. 캐릭터 일관성 유지

동일한 캐릭터가 여러 장면에서 등장하도록 요청합니다.

![캐릭터 일관성 예시](images/webtooni-examples-6.png){width=600}
