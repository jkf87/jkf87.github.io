...
tags:
  ...
  - paper-review
draft: false
coverImage: /images/tide-proactive-discovery/fig1-01.png
---
...
![Figure 1: TIDE의 개념도. (A) 기존 reactive 에이전트는 명시적 요청만 처리한다. (B) 하지만 컨텍스트에는 여러 숨겨진 문제가 공존한다. (C) TIDE는 반복 발견과 템플릿으로 이 문제들을 체계적으로 찾아낸다.](/images/tide-proactive-discovery/fig1-01.png)
...
![Figure 2: 반복 발견의 효과. TIDE는 여러 라운드에 걸쳐 꾸준히 새로운 문제를 발견하는 반면, 병렬 멀티에이전트는 두 번째 단계부터 재발견(re-discovery) 비율이 급증한다.](/images/tide-proactive-discovery/fig2-02.png)
...
![Figure 6: 반복 발견과 템플릿의 상보적 효과. 반복(왼쪽)은 커버리지를, 템플릿(오른쪽)은 정밀도를 각각 주로 끌어올린다.](/images/tide-proactive-discovery/fig6-06.png)
