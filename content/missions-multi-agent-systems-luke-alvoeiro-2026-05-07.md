...
![Luke Alvoeiro가 "15× harder" 문제를 해결하는 에이전트 팀 조립법을 소개하고 있다](./images/missions-multi-agent-systems-luke-alvoeiro-2026-05-07/01-luke-intro.png)
...
![Delegation, Creator-Verifier, Direct Communication, Negotiation, Broadcast — 5가지 멀티에이전트 전략](./images/missions-multi-agent-systems-luke-alvoeiro-2026-05-07/02-five-strategies.png)

## 3개 역할이 핵심이다 — 오케스트레이터, 워커, 검증자

![Orchestrator·Workers·Validators 3역할 아키텍처 — validation contract가 코딩 전에 완료 기준을 정의한다](./images/missions-multi-agent-systems-luke-alvoeiro-2026-05-07/04-three-role-arch.png)
...
![병렬 처리가 오히려 충돌과 중복을 유발하는 이유 — Why serial beats parallel](./images/missions-multi-agent-systems-luke-alvoeiro-2026-05-07/08-mission-control.png)

## Validation Contracts — 구현 전에 약속한다

![Validation Contract + Scrutiny Validator + User-Testing Validator — 구현과 검증이 완전히 분리된 구조](./images/missions-multi-agent-systems-luke-alvoeiro-2026-05-07/06-validation-loop.png)
...
![16일간 Slack 클론을 빌드한 실제 미션의 분석 — 에이전트 실행 수, 토큰, 테스트 커버리지 90%](./images/missions-multi-agent-systems-luke-alvoeiro-2026-05-07/09-production-data.png)
...
![Missions는 위임·검증·브로드캐스트·협상을 하나의 생태계로 결합한다](./images/missions-multi-agent-systems-luke-alvoeiro-2026-05-07/12-composition.png)
