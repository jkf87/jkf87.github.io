...
![Hindsight Banner](/hindsight-images/hindsight-github-banner.png)
...
![Benchmark Results](/hindsight-images/hindsight-benchmarks.png)
...
![Architecture Overview](/hindsight-images/hindsight-overview.webp)
...
![Retain Operation](/hindsight-images/retain-operation.webp)
...
![Recall Operation](/hindsight-images/recall-operation.webp)
...
![Reflect Operation](/hindsight-images/reflect-operation.webp)
...
![Migration Code](/hindsight-images/migration-code.png)
...
![Per-User Requirements](/hindsight-images/per-user-memory-requirements.png)

가장 직관적인 사용 사례는 **사용자 개인화 AI 챗봇**이다. 각 사용자의 대화와 행동을 retain하고, 메타데이터로 사용자를 구분하면:

![Per-User How-to](/hindsight-images/per-user-memory-howto.png)
