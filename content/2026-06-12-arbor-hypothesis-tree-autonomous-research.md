...
![Arbor 프레임워크 전체 구조 — coordinator가 트리를 관리하고 executor가 개별 가설을 격리된 worktree에서 실험](/images/2026-06-12-arbor-hypothesis-tree-autonomous-research/fig2-framework.png)
...
![토큰 예산 대비 상대적 held-out 개선 — Arbor가 같은 예산으로 더 큰 성능 향상 달성](/images/2026-06-12-arbor-hypothesis-tree-autonomous-research/fig4-token-budget.png)
...
![6개 AO 태스크에서의 탐색 효율성 — Arbor의 best-so-far dev gain 곡선과 held-out test 최고점](/images/2026-06-12-arbor-hypothesis-tree-autonomous-research/fig5-exploration-efficiency.png)
...
![Arbor의 에이전트 수준 구현 세부사항 — coordinator, executor, merge gate 전체 아키텍처](/images/2026-06-12-arbor-hypothesis-tree-autonomous-research/fig8-agent-details.png)
