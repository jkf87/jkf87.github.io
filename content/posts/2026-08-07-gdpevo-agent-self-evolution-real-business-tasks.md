...
1. 기존 평가의 문제 세 가지. 첫째, ALFWorld·WebShop 같은 연구용 환경에 머물러서 CRM·ERP·의료·법무 같은 실제 기업 워크플로우를 다룬 벤치마크가 없었음. 둘째, train-test split이 학습 효과를 의도적으로 설계하지 않아서 점수가 올라도 경험 때문인지 운 때문인지 알 수 없었음. 셋째, 정적 벤치마크는 학습 데이터 오염으로 유효성이 무너짐.
