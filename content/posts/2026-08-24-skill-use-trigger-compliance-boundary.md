...
![트리거 설계 비교](/images/2026-08-24-skill-use-trigger-compliance-boundary/fig-3-p7.png)
...
![주요 결과](/images/2026-08-24-skill-use-trigger-compliance-boundary/fig-5-p8.png)
...
![세부 분석](/images/2026-08-24-skill-use-trigger-compliance-boundary/fig-6-p9.png)
...
9. 문제제기. 채점 루브릭이 다중 에이전트 심사 + 인간 감사(κ=0.65, 두 심사자의 동의 수준을 재는 통계 지표로 1이면 완전 일치)를 거쳤지만 여전히 자동 채점 의존도가 큼. 그리고 두 하네스(CC, Codex)만 비교해서 다른 하네스 일반화는 열려있음. κ=0.65도 상당히 낮은 동의 수준이라 루브릭 자체의 모호함이 결과에 섞였을 수 있음.
