...
![Opus 4.7 vs Opus 4.6 전체 벤치마크 비교](./images/claude-opus-4-7/benchmark-table.png)
*Anthropic 공식 벤치마크 비교 표 — 코딩, 에이전트, 비전, 금융, 안전 분야에서 Opus 4.7 성능*
...
![코딩 벤치마크 성능 비교](./images/claude-opus-4-7/chart-1.png)
*주요 코딩 벤치마크에서 Opus 4.7의 성능 향상*

![에이전트 워크플로우 벤치마크](./images/claude-opus-4-7/chart-2.png)
*멀티스텝 에이전트 워크플로우에서의 성능 비교*

![시각 및 멀티모달 벤치마크](./images/claude-opus-4-7/chart-3.png)
*비전 및 멀티모달 능력 비교*
...
![SWE-bench 코딩 태스크 성능](./images/claude-opus-4-7/chart-4.png)
*SWE-bench 시리즈에서 실제 코딩 태스크 해결 능력*

![Terminal Bench 및 전문 도메인 성능](./images/claude-opus-4-7/chart-5.png)
*터미널 사용 및 전문 도메인 평가*

![금융 에이전트 벤치마크](./images/claude-opus-4-7/chart-6.png)
*금융 분석 에이전트 성능 비교*

![멀티모달 리뷰 벤치마크](./images/claude-opus-4-7/chart-7.png)
*멀티모달 코드 리뷰 성능*

![에이전트 자율성 벤치마크](./images/claude-opus-4-7/chart-8.png)
*에이전트 자율성 및 신뢰성 평가*
...
![토큰 사용량 대비 성능 효율](./images/claude-opus-4-7/chart-9.png)
*에포트 레벨별 토큰 사용량 대비 코딩 평가 점수 — Opus 4.7은 더 적은 토큰으로 더 높은 성능 달성*
