...
![Luke Alvoeiro가 AI Engineer Europe 2026에서 Missions를 소개하고 있다](./images/missions-blog/01-luke-stage.png)
...
![5가지 멀티에이전트 패턴의 관계도](./images/missions-blog/02-patterns-diagram.png)
...
![동시 작업 vs 직렬 작업의 정확도 비교](./images/missions-blog/03-serial-vs-parallel.png)
...
![Slack 클론 구현 진행 과정](./images/missions-blog/04-slack-clone-progress.png)
