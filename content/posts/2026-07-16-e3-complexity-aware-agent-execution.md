...
2. 이 낭비를 처음으로 숫자로 잡은 게 ACRR(인지 중복 비율)임. 실제 소비 비용에서 오라클(정답 경로를 미리 아는 이상적 기준)이 정의한 최소 충분 비용을 빼고 나눈 지표인데, 쉬운 작업일수록 이 값이 극단적으로 커짐. "성공은 같은데 비용이 다르다"를 비교할 언어가 생긴 셈임.
...
![E3 프레임워크 개요(논문 Figure 1)](/images/2026-07-16-e3-complexity-aware-agent-execution/fig-1-p9.png)
