...
형식: YouTube 데모 자막과 [EdTech Innovation Hub의 해커톤 결과 보도](https://www.edtechinnovationhub.com/news/a-doctor-a-carpenter-and-a-teacher-win-anthropics-global-opus-47-hackathon)를 바탕으로 핵심 질문과 답변을 인터뷰 스타일로 재구성함.
...
> [데모 영상](https://www.youtube.com/watch?v=Hen24w2Jyz4) · [GitHub](https://github.com/zestones/Aria)
...
> [데모 영상](https://www.youtube.com/watch?v=OZ2D_p82z6w) · [GitHub](https://github.com/Junkz3/wrench-board) · [웹사이트](https://wrenchboard.cloud)
...
> [데모 영상](https://www.youtube.com/watch?v=6bN6hnx-A2A) · [GitHub](https://github.com/bedriyan/medkit-app) · [데모 사이트](https://medkit-app.vercel.app/)
...
이 해커톤에서 가장 중요한 건 모델 성능이 아니었습니다.

더 중요한 건 이겁니다.

문제에 가장 가까운 사람이 직접 해결책을 만들 수 있게 됐다.

목수의 아들이 수리 도구를 만들고, 의사가 환자 시뮬레이터를 만들고, 교사가 사고력 훈련 도구를 만들었습니다. 각자 자기 분야의 암묵지를 AI로 끌어올린 겁니다.

AI 에이전트 시대의 경쟁력은 프롬프트를 잘 쓰는 능력이 아닙니다. 자기가 아는 문제를 AI가 풀 수 있는 구조로 번역하는 능력입니다. 그리고 그 번역의 질은, 문제에 얼마나 가까이 있었느냐에 달려 있습니다.
