...
date: 2026-05-05
slug: 40s-vitamin-d-deficiency-2026-05-05
tags:
  - 40대건강
  - 비타민D
  - 피로
...
aliases:
  - 40s-vitamin-d-deficiency-2026-05-05/index
---
...
![](./images/40s-vitamin-d-deficiency-2026-05-05/hero.png)

2. 햇빛이 가장 큰 출발점임. NIH는 피부가 햇빛에 노출될 때 비타민 D가 만들어진다고 설명함. MSD도 창문을 통과한 빛으로는 충분히 만들기 어렵다고 적었음. 사무실 안에서 빛만 봐서는 부족하기 쉬웠음.
...
![](./images/40s-vitamin-d-deficiency-2026-05-05/diagram.png)
...
12. 그래서 확인 포인트는 세 개면 됨. 햇빛을 얼마나 못 봤는지, 근육통이나 뼈 통증이 있는지, 검진에서 `25(OH)D`를 봤는지임. 이 셋이 같이 보이면 그냥 피곤한 날이 아닐 수 있음.
