...
이런 멀티 모델 조합을 **한 줄짜리 커맨드**로 돌리는 실전 레시피 50가지를 정리한 책이 있다. 블 크의 [『이게 되네? 오픈클로 미친 활용법 50제』 (교보문고)](https://product.kyobobook.co.kr/detail/S000219615902)다. ChatGPT · Claude · Gemini를 오픈클로 하네스 한 곳에서 `plan → work → review`로 묶어 돌리는 구성이 중심이며, GPT-5.5 투입 직후인 지금 라우팅 예제를 그대로 오늘 자 가격표에 꽂아 넣을 수 있다.
...
- 오픈클로 책: [『이게 되네? 오픈클로 미친 활용법 50제』 (교보문고)](https://product.kyobobook.co.kr/detail/S000219615902)
