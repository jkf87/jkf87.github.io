---
title: "OpenHuman — 당신의 데이터를 기억하는 오픈소스 AI 에이전트"
date: 2026-05-14
tags:
  - ai
  - open-source
...
![OpenHuman Demo](./demo.png)

---

## 4컷 만화로 보는 OpenHuman

![OpenHuman 4컷 만화 — AI가 나에 대해 아무것도 모른다 → 원클릭 연동 → 20분 자동 동기화 → 이미 다 정리했습니다!](./openhuman-4panel-comic.jpg)
...
![Memory Tree 구조 — 모든 데이터가 로컬에서 구조화](./memory-tree.png)
